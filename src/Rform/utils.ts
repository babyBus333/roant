...
export function getRequiredMessage<T extends { type?: string }>(field: T, formLocale: Record<string, any>) {
...
export function getPlaceHolder<T extends { type?: string }>(field: T, formLocale: Record<string, any>):string {
